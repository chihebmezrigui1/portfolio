      ...
      <Card.Body>
        <blockquote className="blockquote mb-0">
          <p style={{ textAlign: "justify" }}>
            ...
            <br />
            a Master’s student in Data Science at IPSSI Paris .
            <br />
            I’m currently in my final year (Master 2) and on track to graduate this year.
            <br />
            Alongside my studies , I work in alternance at RDIUP, gaining hands-on experience while applying my skills in real-world projects.             
            <br />
            <br/>
